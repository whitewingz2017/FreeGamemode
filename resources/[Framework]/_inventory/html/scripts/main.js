  ...
  _createClass(Inventory, [{
    ...
    value: function initScript() {
      window.vm = new vue_dist_vue_common__WEBPACK_IMPORTED_MODULE_0___default.a({
        ...
        methods: {
          dTabSelected: function dTabSelected(tabSelected) {
            switch (tabSelected) {
              case "All":
                return this.translations.ALL_ITEMS;
                break;

              case "food":
                return this.translations.FOOD;
                break;

              case "beverage":
                return this.translations.DRINKS;
                break;

              case "weapon":
                return this.translations.WEAPONS;
                break;

              case "ammo":
                return this.translations.AMMO;
                break;

              case "shirts":
                return this.translations.SHIRTS;
                break;

              case "normal":
                return this.translations.UTILS;
                break;

              case "vehicles":
                return this.translations.VEHICLE;
                break;

              case "identity":
                return this.translations.IDENTITY;
                break;
            }
          ...
          updatePrimaryItems: function updatePrimaryItems(receivedData) {
            ...
            for (var _i2 = 0, _Object$entries2 = Object.entries(this.primaryItemsObject); _i2 < _Object$entries2.length; _i2++) {
              ...
              this.primaryItemsArray.push({
                id: itemId,
                fName: itemData.id,
                icon: "../assets/inventory/" + itemData.id + ".png",
                name: itemData.name,
          ...
          clearSelected: function clearSelected() {
            this.hoverSelectedPrimary = null;
    ...
    switch (event.data.action) {
      case "show_primary_inventory":
        if (event.data.items) {
          ...
          window.vm.translations = event.data.language;
...
module.exports = __webpack_require__(/*! C:\Users\Gabriel\Desktop\UI\Inventory\src\scripts\main.js */"./src/scripts/main.js");
